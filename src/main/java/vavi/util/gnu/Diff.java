...
public class Diff {
     ...
     *
     * We scan from the beginnings of the files,
     * and simultaneously from the ends,
    ...
    private int diag(int xoff, int xlim, int yoff, int ylim) {
    	...
    	for (int c = 1;; ++c) {
            ...
            for (d = fmax; d >= fmin; d -= 2) {
                int x, y, oldx;
                int tlo = fd[fdiagoff + d - 1], thi = fd[fdiagoff + d + 1];
            ...
            for (d = bmax; d >= bmin; d -= 2) {
                int x, y, oldx;
                int tlo = bd[bdiagoff + d - 1], thi = bd[bdiagoff + d + 1];
    ...
    public static void main(String[] argv) throws IOException {
        ...
        Diff.Change script = d.getChange(edstyle);
        if (script == null) {
            ...
            if (edstyle) {
                ...
                p = new DiffUtil.NormalPrinter(a, b);
            }
            p.print(script);
        }
    }
