...
public class JavaParser/*@bgen(jjtree)*/implements JavaParserTreeConstants, JavaParserConstants {/*@bgen(jjtree)*/
  protected JJTJavaParserState jjtree = new JJTJavaParserState();// added a main. DW, 7/99
    public static void main(String[] args) {
        final String MYNAME = "Java Parser Version 1.1 (for Java1.2 code): ";
        JavaParser parser;
        ...
        if (args.length == 1) {
            filename = args[0];
            System.err.println(MYNAME + "Reading from file " + filename + " ...");
            try {
                startTime = System.currentTimeMillis();
                parser = new JavaParser(new SimpleCharStream(
                ...
                System.err.println(MYNAME + "UnsupportedEncode: " + e);
                return;
            }
            catch (java.io.FileNotFoundException e) {
                System.err.println(MYNAME + "File " + filename + " not found.");
                return;
            }
        }
        else {
            System.err.println(MYNAME + "Usage is one of:");
        ...
        try {
            ...
            System.err.println("Java program parsed " + filename + " successfully in " + (initTime + parseTime) + " ms.");
            System.err.println("\tparser initialization time was " + initTime + " ms.");
            System.err.println("\tparser parse time was " + parseTime + " ms.");
        }
        catch (ParseException e) {
            System.err.println(e.getMessage());
            System.err.println(MYNAME + "Encountered errors during parse.");
        }
    }
